...
# Make Deb Package for phish aware (^.^)
_PACKAGE=phish aware
_VERSION=2.3.5
_ARCH="all"
...
Maintainer: @htr-tech
Depends: ${_depend}
Homepage: https://github.com/saiyan3457/Phish-Aware
...
cp -fr .github/ .sites/ LICENSE README.md phishaware.sh ./build_env/$_opt_dir
